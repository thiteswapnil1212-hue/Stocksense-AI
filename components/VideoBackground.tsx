...
export function VideoBackground({
  ...
  return (
    ...
    >
      ...
      {overlay === 'default' ? (
        <>
          <div className="hero-gradient absolute inset-0 mix-blend-screen opacity-90" />
        ...
        <>
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_0%,rgba(79,124,255,0.15),transparent_40%),radial-gradient(circle_at_100%_50%,rgba(0,229,255,0.1),transparent_30%)] mix-blend-screen" />
